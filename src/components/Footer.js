                    ...
                    <div className='row'>
                        ...
                        <div className='col-2'>
                            ...
                            <div className='footer-links d-flex flex-column'>
                                ...
                                <Link className='text-white py-2 mb-1'>Dresses</Link>
                                <Link className='text-white py-2 mb-1'>Perfurmes</Link>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='container-xxl'>
                    <div className='row'>
                        <div className='col-12'>
                            <p className='text-center mb-0 text-white'>&copy;{new Date().getFullYear()}; powered by nasteho
                            </p>
                        </div>
                    </div>
                </div>
