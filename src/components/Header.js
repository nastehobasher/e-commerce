                    ...
                    <div className='row'>
                        ...
                        <div className='col-6'>
                            <p className='text-end text-white mb-0'>Hotline:
                                <a className='text-white' href='tel:+252 633003794'>+252 633003794</a></p>
                        </div>
                    </div>
                </div>
            </header> */}
            <header className='header-upper py-3'>
                <div className='container-xxl'>
                    <div className='row align-items-center'>
                        ...
                        <div className='col-5'>
                            <div className='header-upper-links d-flex align-items-centr justify-content-between'>
                                <div>
                                ...
                                <div>
                                    <Link
                                        to={authState?.user === null ? "/login" : "/my-profile"} className='d-flex align-items-center gap-10 text-white'>
                                        <img src={user} alt="user" />
                                        {
                                            authState.user === null ? <p className='mb-0'>Log in <br /> My Acount</p> : <p className='mb-0'> welcome {authState?.user?.firstname} </p>
                                        }
                                    </Link>
                                </div>
                                <div>
